...
*/
const isDivisibleBy = function(yr,num){
  return yr % num === 0;
};
const getLeapyear = function(year){
  let result = '';
  if((isDivisibleBy(year,4) && isDivisibleBy(year,100) && isDivisibleBy(year,400)) || (isDivisibleBy(year,4) && !isDivisibleBy(year,100)))
  {
