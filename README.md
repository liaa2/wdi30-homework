# WDi-30 ([General Assembly, Sydney](https://generalassemb.ly/sydney))
### Homework Repository
...
- **Clone your forked repository to your computer**
    ...
    + Make sure you're browser is open to **your** forked version of this repository on Github (eg [http://github.com/{{YOUR_USERNAME}}/wdi30-homework](http://github.com/{{YOUR_USERNAME}}/wdi30-homework)).
...
- **Add an upstream remote repository**
    ...
    + `cd homework`
    + `git remote add upstream https://github.com/liaa2/wdi30-homework.git`
...
- **Once you're finished, submit a pull request for me to accept your homework**
    + Navigate to your forked version of this repository on Github (eg [https://github.com/{{YOUR_USERNAME_HERE}}/wdi30-homework](https://github.com/{{YOUR_USERNAME_HERE}}/wdi30-homework)).
