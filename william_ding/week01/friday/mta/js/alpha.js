...
// Same Line ............................................................
  ...
  // check directions.
    if ( line1.indexOf(station1) < line1.indexOf(station2) ) {
    ...
    // Same line. right to left.
     else if ( line1.indexOf(station1) > line1.indexOf(station2) ) {
...
// Union Square as start Station .........................................
  else if (station1 === "Union Square") {
    // check directions.
    if ( line2.indexOf("Union Square") < line2.indexOf(station2) ) {
    // "Union Square" left to right.
      const stops = lToR(finishLine, "Union Square", station2);
      console.log(`You must travel through the following stops on the ${ finishLine } line: ${ stops.join(", ") }.`);
      console.log(`${ stops.length } stops in total.`);
      return;
    }
    // "Union Square" right to left.
    else if ( line2.indexOf("Union Square") > line2.indexOf(station2) ) {
...
// First line left to right
    if ( line1.indexOf(station1) < line1.indexOf("Union Square") ) {
  ...
  // Second line right to left
       ...
       if ( line2.indexOf("Union Square") > line2.indexOf(station2) ) {
        ...
        return lineStops1.join(", ");
      }
  }
// First line right to left
  else if ( line1.indexOf(station1) > line1.indexOf("Union Square") ) {
  // Second line left to right
  if ( line2.indexOf("Union Square") < line2.indexOf(station2) ) {
    const stops1 = rtoL(startLine, station1, "Union Station");
    const stops2 = lToR (finishLine, "Union Square", station2);
    console.log(`You must travel through the following stops on the ${ startLine } line: ${stops1.join(", ")}.`);
    console.log(`Change line at Union Square to line ${ finishLine }.`)
    console.log(`Your journey continues through the following stops: ${ stops2.join(", ") }.`);
...
// Second line right to left
    ...
    console.log(`${ stops1.length + stops2.length} stops in total.`);
    return;
    // lineStops2 = rtoL (finishLine, "Union Square", station2);
    // return `${lineStops1.join(", ")}, ${lineStops2.join(", ")}`;
  } else {
    return lineStops1.join(", ");
  }
  }
