...
////EXTRACT NUMBER, AND TURN IT INTO AN ARRAY.

const creditCardObject = {
  card1: '1111-2222-3333-4444',
  card2: '111a-2222-3333-5555',
  card3: '4444-5555-6666-777',
};

const extractNumberArray = function (object) {
  let object2Array = Object.values( object );
  let newArray = []
  for (let i = 0; i < object2Array.length; i++) {
    let noHyphen = object2Array[i].replace(/-/g, "");
    let floatNumber = +(noHyphen);
    newArray.push(floatNumber);
  }
  return newArray;
};

const creditCardArray = extractNumberArray(creditCardObject);
console.log(creditCardArray);

const splitCardNumber = function(array) {
...
// };
//
// console.log(arraySum(creditCardArray));
